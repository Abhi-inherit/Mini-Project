<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="womens.aspx.cs" Inherits="Buyit.womens" %>
	...
	<div class="header-bot_inner_wthreeinfo_header_mid">
		...
		<!-- header-bot -->
			<div class="col-md-4 logo_agile">
				<h1><a href="index.aspx"><span>Buy IT</span>Online Shoppy <i class="fa fa-shopping-bag top_logo_agile_bag" aria-hidden="true"></i></a></h1>
			</div>
        <!-- header-bot -->
							...
							<ul class="dropdown-menu multi-column columns-3">
								<div class="agile_inner_drop_nav_info">
									<div class="col-sm-6 multi-gd-img1 multi-gd-text ">
										<a href="mens.aspx"><img src="images/top2.jpg" alt=" "/></a>
									</div>
						...
						<a href="#" class="dropdown-toggle menu__link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Women's wear <span class="caret"></span></a>
							<ul class="dropdown-menu multi-column columns-3">
								<div class="agile_inner_drop_nav_info">
									<div class="col-sm-3 multi-gd-img">
										<ul class="multi-column-dropdown">
											<li><a href="womens.aspx">Clothing</a></li>
											<li><a href="womens.aspx">Wallets</a></li>
											<li><a href="womens.aspx">Footwear</a></li>
											<li><a href="womens.aspx">Watches</a></li>
											<li><a href="womens.aspx">Accessories</a></li>
											<li><a href="womens.aspx">Bags</a></li>
											<li><a href="womens.aspx">Caps & Hats</a></li>
										</ul>
									</div>
									<div class="col-sm-3 multi-gd-img">
										<ul class="multi-column-dropdown">
											<li><a href="womens.aspx">Jewellery</a></li>
											<li><a href="womens.aspx">Sunglasses</a></li>
											<li><a href="womens.aspx">Perfumes</a></li>
											<li><a href="womens.aspx">Beauty</a></li>
											<li><a href="womens.aspx">Shirts</a></li>
											<li><a href="womens.aspx">Sunglasses</a></li>
											<li><a href="womens.aspx">Swimwear</a></li>
										</ul>
									</div>
									<div class="col-sm-6 multi-gd-img multi-gd-text ">
										<a href="womens.aspx"><img src="images/top1.jpg" alt=" "/></a>
									</div>
									<div class="clearfix"></div>
								</div>
							</ul>
					...
					<li><input type="checkbox" checked="checked" id="item-0" /><label for="item-0"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Men's Wear</label>
						<ul>
							<li><input type="checkbox" id="item-0-0" /><label for="item-0-0"><i class="fa fa-long-arrow-right" aria-hidden="true"></i>Ethnic Wear</label>
								<ul>
									<li><a href="mens.aspx">Shirts</a></li>
									<li><a href="mens.aspx">Caps</a></li>
									<li><a href="mens.aspx">Shoes</a></li>
									<li><a href="mens.aspx">Pants</a></li>
									<li><a href="mens.aspx">SunGlasses</a></li>
									<li><a href="mens.aspx">Trousers</a></li>
								</ul>
							</li>
		...
		<div class="col-md-4 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.aspx">Black Basic Shorts</a></h4>
			...
			<div class="col-md-4 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.aspx">Costa Swiss Bag </a></h4>
										<div class="info-product-price">
			...
			<div class="col-md-4 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.aspx">Aero Canvas Loafers  </a></h4>
										<div class="info-product-price">
											<span class="item_price">$120.99</span>
											<del>$199.71</del>
										</div>
		...
		<div class="single-pro">
			 <div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.aspx">A-line Black Skirt</a></h4>
										<div class="info-product-price">
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.aspx">Sleeveless Solid Blue Top</a></h4>
										<div class="info-product-price">
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.aspx">Skinny Jeans</a></h4>
										<div class="info-product-price">
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.aspx">Pink Track Pants</a></h4>
										<div class="info-product-price">
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.aspx">Analog Watch</a></h4>
										<div class="info-product-price">
						    ...
						    <div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.aspx">Ankle Length Socks</a></h4>
										<div class="info-product-price">
								...
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.aspx">Reebok Women's Tights</a></h4>
										<div class="info-product-price">
											<span class="item_price">$130.99</span>
											<del>$169.71</del>
										</div>
...
<div class="footer">
	<div class="footer_agile_inner_info_w3l">
		<div class="col-md-3 footer-left">
			<h2><a href="index.aspx"><span>Buy IT</span>Online Shoppy </a></h2>
			...
			<div class="sign-grds">
				<div class="col-md-4 sign-gd">
					...
					<ul>
						...
						<li><a href="womens.aspx">Women's wear</a></li>
						<li><a href="about.aspx">About</a></li>
						<li><a href="typography.aspx">Short Codes</a></li>
