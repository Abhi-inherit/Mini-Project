<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mens.aspx.cs" Inherits="Buyit.mens" %>
		...
		<div class="col-md-8 products-right">
								...
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
                                       ...
                                       <%-- First image to display--%>
										...
										<img id="img1"  alt="" class="pro-image-front">
										<img id="img2"  alt="" class="pro-image-back">
									...
									<div class="item-info-product ">
										<h4><a href="single.aspx">Party Men's Blazer</a></h4>
			...
			<div class="col-md-4 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.aspx">Running Shoes</a></h4>
										<div class="info-product-price">
		...
		<div class="single-pro">
			<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.aspx">Formal Blue Shirt</a></h4>
										<div class="info-product-price">
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.aspx">Gabi Full Sleeve Sweatshirt</a></h4>
										<div class="info-product-price">
											<span class="item_price">$45.99</span>
											<del>$69.71</del>
										</div>
                            ...
                            <div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.aspx">Dark Blue Track Pants</a></h4>
										<div class="info-product-price">
											<span class="item_price">$80.99</span>
											<del>$89.71</del>
										</div>
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.aspx">Round Neck Black T-Shirt</a></h4>
										<div class="info-product-price">
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.aspx">Men's Black Jeans</a></h4>
										<div class="info-product-price">
								...
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.aspx">Reversible Belt</a></h4>
										<div class="info-product-price">
